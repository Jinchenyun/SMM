...
print('Load dataset...')
data = Caltech(standardize=True, test_size=0.3, classes='dolphin_vs_camera')
X, y = data.get_all()
print(X.shape)
...
print(f'average accuracy: {np.mean(np.array(best_score)):.4f} ± {np.std(np.array(best_std)):.4f}')
