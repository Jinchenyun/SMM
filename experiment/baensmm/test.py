...
params = [{'c': 2, 'eta': 1, 'gamma': 10, 'lambda_': 0.1, 'rho': 50, 'tau': 0.1, 'theta': 0.3},
{'c': 0.125, 'eta': 1, 'gamma': 1, 'lambda_': 0.1, 'rho': 50, 'tau': 0.7, 'theta': 0.7},
{'c': 0.5, 'eta': 1, 'gamma': 100, 'lambda_': 10, 'rho': 50, 'tau': 0.1, 'theta': 0.7},
{'c': 2, 'eta': 1, 'gamma': 10, 'lambda_': 0.1, 'rho': 50, 'tau': 0.1, 'theta': 0.5},
{'c': 8, 'eta': 1, 'gamma': 10, 'lambda_': 0.1, 'rho': 50, 'tau': 0.1, 'theta': 0.7},
{'c': 0.25, 'eta': 1, 'gamma': 1, 'lambda_': 0.1, 'rho': 50, 'tau': 1, 'theta': 0.3},
{'c': 2, 'eta': 1, 'gamma': 1, 'lambda_': 0.01, 'rho': 50, 'tau': 0.1, 'theta': 0.3},
{'c': 0.5, 'eta': 1, 'gamma': 10000, 'lambda_': 10, 'rho': 50, 'tau': 0.5, 'theta': 0.7},
{'c': 2, 'eta': 1, 'gamma': 1000, 'lambda_': 1, 'rho': 50, 'tau': 0.3, 'theta': 0.1},
{'c': 1, 'eta': 1, 'gamma': 1, 'lambda_': 0.1, 'rho': 50, 'tau': 0.3, 'theta': 0.5}]

classes = 'dolphin_vs_butterfly'
...
for best_param in params:
    ...
    model = BaenSMM(cccp_epochs=200, admm_epochs=10, epsilon=1e-5)
